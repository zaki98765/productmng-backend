 ...
 * @param options
 */
declare const multipart: ({ payloadLimit, payloadLimitErrorFn, type, fileCountLimit, fileSizeLimit, fileSizeLimitErrorFn }?: MultipartOptions & ParserOptions) => (req: ReqWithBody, res: Response, next?: NextFunction) => Promise<void>;
export { custom, json, multipart, raw, text, urlencoded };
